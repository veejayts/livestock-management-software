...
class Toplevel1:
    def __init__(self, top=None):
        ...
        global _img0
        image_exist = os.path.exists(photo_location)
        if image_exist:
        ...
        self.frame1.place(relx=0.01, rely=0.01,
                          relheight=0.095, relwidth=0.075)
        ...
        self.Button2 = tk.Button(
            top, command=lambda: Finance.create_Toplevel1(root))
        ...
        self.Button3 = tk.Button(
            top, command=lambda: addGoat.create_Toplevel1(root))
        ...
        self.Button2_3 = tk.Button(
            top, command=lambda: alerts.create_Toplevel1(root))
    ...
    def plot(self):
        ...
        pd.crosstab(cur_holding.breed, cur_holding.gender).plot(
            kind='bar', ax=ax1, fontsize=12)
        ...
        labels3 = 'Male:' + str(maleDeadCount), 'Female:' + \
            str(femaleDeadCount)
        ...
        df4.plot(kind='bar', legend=True, ax=ax4,
                 color='lightskyblue', fontsize=12)
