...
#    Mar 10, 2020 12:45:22 AM IST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1 = tk.Button(top, command = self.showLivestock)
        ...
        self.Button2 = tk.Button(top, command = self.showLabour)
        ...
        self.Button3 = tk.Button(top, command = self.showFeed)
        ...
        self.Button4 = tk.Button(top, command = self.showHealth)
        ...
        self.Button5 = tk.Button(top, command = self.showMisc)
        ...
        self.Delete2 = tk.Button(self.Frame2)
        ...
        self.Label37.configure(text='''Cost : ''')
        ...
        self.Label39.configure(text='''Weight : ''')
        ...
        self.Delete3 = tk.Button(self.Frame3)
        ...
        self.Delete4 = tk.Button(self.Frame4)
        ...
        self.Delete5 = tk.Button(self.Frame5)
    ...
    def cancel(self, widget):
        widget.place_forget()
        # Mark2
        if widget == self.Frame1:
            self.refreshLiveStockTree()
        elif widget == self.Frame2:
            self.refreshLabourTree()
        elif widget == self.Frame3:
            self.refreshFeedTree()
        elif widget == self.Frame4:
            self.refreshHealthTree()
        elif widget == self.Frame5:
            self.refreshMiscTree()
    ...
    def getHealthData(self, event):
        ...
        self.TEntry28.delete(0,END)
        self.TEntry23.delete(0, END)
        self.TEntry23.insert(END, self.db.getTotalHealthExpenditure())
        self.TEntry26.insert(END,data4['values'][1])
        self.TEntry28.insert(END,data4['values'][2])
        print(data4)
    ...
    def getMiscData(self, event):
        ...
        self.TEntry28.delete(0,END)
        self.TEntry23.delete(0, END)
        self.TEntry23.insert(END, self.db.getTotalMiscCost())
        self.TEntry26.insert(END,data5['values'][1])
        self.TEntry28.insert(END,data5['values'][2])
        print(data5)
